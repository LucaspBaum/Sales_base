...
url = 'https://raw.githubusercontent.com/asimov-academy/Dashboards/main/salesanalysis-dash/dataset_asimov.csv'
df = pd.read_csv(url)
df_cru = df.copy()
...
def convert_to_text(month):
    lista1 = ['Ano Todo', 'Janeiro', 'Fevereiro', 'Março', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Novembro', 'Dezembro']
    return lista1[month]
# =========  Layout  =========== #
